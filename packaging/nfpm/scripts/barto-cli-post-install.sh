...
echo "    Optional: store secrets in the platform keychain (auto-unlocked at login):"
echo "         barto-cli secrets set BARTO_CLI_BARTOS__API_KEY"
echo "         barto-cli secrets list   # check what is stored"
